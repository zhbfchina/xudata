...
$(function () {
    ...
    $('.save').click(function () {
        ...
        if (idx == 0) {
            ...
            if (real_time_update_interval != "" || typeof (real_time_update_interval) != "undefined") {
                if (real_time_update_interval >= 60000) {
                    if (real_time_threshold >= 1) {
                        if (real_time_update_interval != "" || typeof (real_time_update_interval) != "undefined" && real_time_update_interval >= 60000){
                            //return real_time_update_interval, real_time_threshold;
                            $(window.parent.real_time_configPara(real_time_update_interval, real_time_threshold, IsHistory));
